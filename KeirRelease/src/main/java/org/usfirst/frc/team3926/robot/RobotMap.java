...
public class RobotMap {
    ...
    public final static int      DRIVE_TRAIN_RIGHT_ENCODER_A_CHANNEL = 5;
    /** DIO port for the drive train's right encoder B channel */
    public final static int      DRIVE_TRAIN_RIGHT_ENCODER_B_CHANNEL = 6;
    /** DIO port for the drive train's left encoder A channel */
    public final static int      DRIVE_TRAIN_LEFT_ENCODER_A_CHANNEL  = 7;
    /** DIO port for the drive train's left encoder B channel */
    public final static int      DRIVE_TRAIN_LEFT_ENCODER_B_CHANNEL  = 8;
    ///// Motor CAN IDs /////

 ...
 *      TODO configure RIO on robor
 *      TODO add JVM to RIO on robot
 **********************************************************************************************************************/
...
public class RobotMap {
    ...
    public final static int      SHOOTER_CAN_ID                      = 100; //TODO add actual value
    ...
    public final static int      SHOOTER_ENCODER_A_CHANNEL           = 0; //TODO add actual value
    /** DIO port for the shooter's encoder's B channel */
    public final static int      SHOOTER_ENCODER_B_CHANNEL           = 1; //TODO add actual value
    /**  */
    ...
    public final static int      AGITATOR_CAN_ID                     = 101; //TODO add actual value
    ...
    public final static int      AGITATOR_ENCODER_A_CHANNEL          = 2; //TODO add actual value
    /** DIO port for the agitator's encoder's B channel */
    public final static int      AGITATOR_ENCODER_B_CHANNEL          = 3; //TODO add actual value
    ...
    public final static int      CLIMBER_CAN_ID                      = 103; //TODO add actual value
    /** CAN ID for the climbing system's second motor controller (used if {@link #CLIMBER_USE_CAN_TALON} is true) */
    public final static int      CLIMBER_SECOND_CAN_ID               = 104; //TODO add actual value
    ...
    public final static int      CLIMBER_LIMIT_SWITCH_PORT           = 4; //TODO add actual value
    /** Speed to climb at */
    ...
    public final static int      BALL_COLLECTION_CAN_ID              = 102; //TODO add actual value
    ...
    public final static int      GEAR_PLACEMENT_CAN_ID               = 121; //TODO add actual value
    ...
    public final static int      DRIVE_RIGHT_ENCODER_A_CHANNEL       = 5; //TODO add actual value
    /** DIO port for the drive train's right encoder B channel */
    public final static int      DRIVE_RIGHT_ENCODER_B_CHANNEL       = 6; //TODO add actual value
    /** DIO port for the drive train's left encoder A channel */
    public final static int      DRIVE_LEFT_ENCODER_A_CHANNEL        = 7; //TODO add actual value
    /** DIO port for the drive train's left encoder B channel */
    public final static int      DRIVE_LEFT_ENCODER_B_CHANNEL        = 8; //TODO add actual value
    /**  */
    public final static double   DRIVE_ENCODER_DISTANCE_PER_PULSE    = 6 * Math.PI / 20;
    ///// Motor CAN IDs /////
    /** CAN ID for front right motor */
    public final static int      FRONT_RIGHT_MOTOR_CAN               = 1; //TODO add actual value
    /** CAN ID for back right motor */
    public final static int      BACK_RIGHT_MOTOR_CAN                = 4; //TODO add actual value
    /** CAN ID for front left motor */
    public final static int      FRONT_LEFT_MOTOR_CAN                = 3; //TODO add actual value
    /** CAN ID for back left motor */
    public final static int      BACK_LEFT_MOTOR_CAN                 = 2; //TODO add actual value
    ///// Motor PWM IDs /////
